...
vs smooth survivor cohorts (spread ≤ 0.006), six random sub-universes
(≤ 0.009), and a 15-cell window×universe grid marching q from 0.10 to 1.20 —
**visiting the design-target q ≈ 0.79 exactly and the formally singular
q > 1 corner** (max spread 0.023, at the target cell itself; 0/669
non-optimal solves). All five came back with nothing. **The contribution
is the structural eigenvalue work**: the iterative edge correction
(14 → 24 real factors per window), the signature spectrum, the crisis
dimensionality collapse. The portfolio horse-race never materialized.
